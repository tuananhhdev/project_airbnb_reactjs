...
import { listAPI } from "../../../service/API/API";
          ...
          <div key={index}>
            ...
            <div className="container mx-auto px-20">
              <div>
                ...
                {/* </span> */}
                {/* <span className="underline text-sm font-normal tracking-widest mx-1"> */}
                {/* {roomDetail?.locationId ? roomDetail?.locationId.name : ""},{" "} */}
                {/* {roomDetail?.locationId ? roomDetail?.locationId.province : ""},{" "} */}
                {/* {roomDetail?.locationId ? roomDetail?.locationId.country : ""} */}
                {/* </span>
                  </div> */}
                {/* <div className="flex flex-wrap justify-center items-center">
                    <button className="px-2 py-1 hover:bg-gray-100 rounded-md transition-all duration-150 flex justify-center items-center font-semibold text-lg text-gray-700">
                      <svg
                        viewBox="0 0 32 32"
                      ...
                      <span className="ml-2 text-lg">Chia sẻ</span>
                    </button>
              ...
              <div className="w-full flex sm:flex-row flex-col mt-10 border-b pb-5">
                <div className="w-full sm:w-1/2 lg:w-3/5">
                  ...
                  {/* ngôn ngữ */}
                  <div className="mt-5 pb-5 border-t-2 border-gray-300">
                    ...
                    <div className="grid grid-cols-2">
                      ...
                      <div>
                        ...
                        <span className="text-lg ml-3">
                          TV với truyền hình cáp <br /> tiêu chuẩn
                        </span>
                      </div>
                      <div>
                        <i class="fa-regular fa-snowflake text-lg"></i>
                        <span className="text-lg ml-3">Điều hòa nhiệt độ</span>
                      </div>
                      <div>
                        <i class="fa-solid fa-fire text-lg"></i>
                        <span className="text-lg ml-3">Lò sưởi trong nhà</span>
                      </div>
                      <div>
                        <i class="fa-solid fa-square-parking text-lg"></i>
                        <span className="text-lg ml-3">
                          Bãi đỗ xe thu phí nằm ngoài <br /> khuôn viên
                        </span>
                      </div>
                      <div>
                      ...
                      <div className="flex">
                        ...
                        <span className="text-lg ml-3">Sân và ban công</span>
                      </div>
                      <div className="flex">
                        <img
                          width="20"
                      ...
                      <div>
                        ...
                        <span className="text-lg ml-3">Cho phép ở dài hạn</span>
                      </div>
                    </div>
                    {/* // render convenients */}
                    <div className="grid grid-cols-2">
